 ...
 */
public class FormStron extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            lblKQ.setText(" Diện tích = "+ (so1*3.14*so1)+"    Chu vi = "+(so1*2)*3.14);
        }catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormStron.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
